    ...
    <SolutionDetail
      ...
      products={[
        ...
        },
        {
          category: "Networking",
          items: [
            "Networking Switches (Cisco, Juniper, Arista)",
      ...
      highlights={[
        {
          ...
          desc: "SIEM, SOAR, UEBA and threat intelligence for a 360° security posture.",
        },
        {
          icon: "📡",
          title: "Resilient Networking",
          desc: "Cisco, Juniper, and Arista infrastructure built for zero-downtime operations.",
        },
        {
          icon: "🛡️",
          title: "24×7 NOC/SOC",
        ...
        },
        {
          ...
          desc: "Unified IT asset management and NMS for real-time operational insight.",
        },
        {
          icon: "⚡",
          title: "High Performance",
          desc: "Enterprise servers and storage configured for peak throughput and availability.",
        },
        {
          icon: "🤝",
          title: "Certified Partners",
          desc: "Authorized implementation specialists for Cisco, Juniper, Arista, Extreme Networks, and more.",
        },
      ]}
    />
  );
