      ...
      highlights={[
        {
          ...
          desc: "ERP and LMS platforms built to comply with CBSE standards and reporting requirements.",
        },
        {
          icon: "🖥️",
          title: "Interactive Learning",
          desc: "Touch-enabled display panels that make lessons engaging and collaborative.",
        },
        {
          icon: "📱",
          title: "Device-Ready",
          desc: "Laptops, tablets, and desktops configured for modern digital classrooms.",
        },
        {
          icon: "🔗",
          title: "Integrated Platform",
          desc: "Seamless integration between hardware and software for streamlined school management.",
        },
        {
          icon: "👨‍👩‍👧",
          title: "Parent Engagement",
          desc: "Digital portals for real-time academic tracking and parent communication.",
        },
        {
          icon: "💳",
          title: "Flexible Financing",
          desc: "OPEX models that make technology accessible without heavy CapEx investment.",
        },
      ]}
    />
  );
